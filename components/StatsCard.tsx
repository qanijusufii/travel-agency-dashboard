...
const StatsCard = ({headerTitle, total, lastMonthCount,currentMonthCount}: StatsCard) => {
    ...
    const isDecrement = trend === 'decrement'; //checking for quality and turning that quality into boolean so we can use more easily within the cards
    return (
                    ...
                    <div className="flex items-center gap-2">
                        <figure className="flex items-center gap-1">
                            <img src={`/assets/icons/${isDecrement ? 'arrow-down-red.svg' : 'arrow-up-green.svg'}`}
                                 ...
                                 alt="arrow"
                            />
                            <figcaption className={cn('text-sm font-medium', isDecrement && isDecrement ? 'text-red-500' : 'text-success-700')}>
